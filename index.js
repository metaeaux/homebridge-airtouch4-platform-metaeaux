...
Airtouch.prototype.setupACAccessory = function(accessory) {
	...
	thermostat
		...
		.on("get", function(cb){ this.api.requestACStatus(() => {
...
Airtouch.prototype.setupZoneAccessory = function(accessory) {
	...
	zone
		...
		.on("get", function(cb){ this.api.requestGroupStatus(() => cb(null, this.context.active)); }.bind(accessory))
...
*/
	...
	sensor
		.getCharacteristic(Characteristic.CurrentTemperature)
		.on("get", function(cb){ this.api.requestGroupStatus(() => cb(null, this.context.currentTemperature));  }.bind(accessory));
